                ...
                <Table className={classes.table} aria-label="simple table" style={{ width: '100%', border: 'none', borderBottom: "none" }} >
                    <TableHead style={{ background: '#fafafa', border: '0px ', borderBottom: "none" }}>
                        <TableRow style={{ borderBottom: "none" }}>
                            ...
                            <TableCell align="left" width={'10%'} ><b>Product Price</b></TableCell>
                            <TableCell align="left" ><b>Discount</b></TableCell>
                            <TableCell align="left" width={'40%'}><b>Discounted Price</b></TableCell>
                            <TableCell align="center" width={'13%'} ><b>Actions</b></TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                        {rows.map((row, index) => (
                            <Fragment>
                                {(state === 'All') &&
                                    <TableRow key={row.firstName} style={{ color: '#80a4f1' }}>
                                        ...
                                        <TableCell align="left" style={{ borderBottom: "none" }}>{row.discount}%</TableCell>
                                        <TableCell align="left" style={{ color: '#80a4f1', borderBottom: "none" }}>{row.discount > 0 ? (Math.ceil(row.saleprice / row.discount)) : (row.saleprice)}</TableCell>
                                        ...
                                        <TableCell align="left" style={{ justifyContent: 'end', alignItems: 'end', textAlign: 'end', cursor: 'pointer', paddingRight: '5%', borderBottom: "none" }}>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="colums">
                                            <div class="item">
                                                ...
                                                <input id="name" type="text" name="name" value={employee.name} onChange={handleChange} disabled />
                                            </div>
                                            <div class="item">
                                                <label for="type"> Type<span></span></label>
                                                <input id="type" type="text" name="type" value={employee.type} onChange={handleChange} disabled />
                                            </div>
                                            <div class="item">
                                                <label for="brand">Brand<span></span></label>
                                                <input id="brand" type="text" name="brand" value={employee.brand} onChange={handleChange} disabled />
                                            </div>
                                            <div class="item">
                                                <label for="saleprice">Sale Price</label>
                                                <input id="saleprice" type="number" name="saleprice" value={employee.saleprice} onChange={handleChange} disabled />
                                            </div>
                                            <div class="item">
                                                <label for="retailprice">Retail Price</label>
                                                <input id="retailprice" type="text" name="retailprice" value={employee.retailprice} onChange={handleChange} disabled />
                                            </div>
                                            <div class="item">
                                                <label for="part_ID">Part Id</label>
                                                <input id="part_ID" type="text" name="part_ID" value={employee.part_ID} onChange={handleChange} disabled />
                                            </div>
                                            <div class="item">
                                                <label for="quantity">Quantity</label>
                                                <input id="quantity" type="text" name="quantity" value={employee.quantity} onChange={handleChange} disabled />
                                            </div>
                                            <div class="item">
                                                <label for="make">Make</label>
                                                <input id="make" type="text" name="make" value={employee.make} onChange={handleChange} disabled />
                                            </div>
                                            <div class="item">
                                                <b style={{ color: 'red', fontSize: '14px' }}> *</b><label for="discount" style={{ color: 'blue' }}><b>Discount(%)</b></label>
                                                <input id="discount" placeholder="(%)" type="text" autoFocus name="discount" value={employee.discount} onChange={handleChange} />
                                            </div>
                                            <div class="item">
                                                <label for="description">Details</label>
                                                <input id="description" type="text" name="description" value={employee.description} onChange={handleChange} disabled />
                                            </div>
                                        </div>
                                    </fieldset>
